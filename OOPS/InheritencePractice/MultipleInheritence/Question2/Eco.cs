namespace Question1
{
    public class Eco:Car,IBrands
    {
        ...
        public Eco(string fuelType,int numberOfSeats,string color,int tankCapacity,int numberOfKmDriven,double litresLoaded,string makingID,string engineNumeber,string chasisNumber):base( fuelType, numberOfSeats, color, tankCapacity, numberOfKmDriven, litresLoaded)
        {
            MakingID=makingID;
